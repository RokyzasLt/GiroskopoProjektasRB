...
static void exseq_main_region_Suvidurkinti(Statechart* handle);
	...
	switch (state)
	{
		case Statechart_main_region_Inicializacija :
			result = (sc_boolean) (handle->stateConfVector[SCVI_STATECHART_MAIN_REGION_INICIALIZACIJA] == Statechart_main_region_Inicializacija
				...
				break;
		case Statechart_main_region_Nuskaityti_Duomenis__ :
			result = (sc_boolean) (handle->stateConfVector[SCVI_STATECHART_MAIN_REGION_NUSKAITYTI_DUOMENIS__] == Statechart_main_region_Nuskaityti_Duomenis__
			);
				break;
		case Statechart_main_region_Suvidurkinti :
			result = (sc_boolean) (handle->stateConfVector[SCVI_STATECHART_MAIN_REGION_SUVIDURKINTI] == Statechart_main_region_Suvidurkinti
			);
				break;
		case Statechart_main_region_Atvaizduoti :
			result = (sc_boolean) (handle->stateConfVector[SCVI_STATECHART_MAIN_REGION_ATVAIZDUOTI] == Statechart_main_region_Atvaizduoti
			);
				break;
			default:
				result = bool_false;
...
static void exseq_main_region(Statechart* handle)
{
	...
	switch(handle->stateConfVector[ 0 ])
	{
		...
		case Statechart_main_region_Suvidurkinti :
		{
			exseq_main_region_Suvidurkinti(handle);
			break;
		}
		case Statechart_main_region_Atvaizduoti :
		{
